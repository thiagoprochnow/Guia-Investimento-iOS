...
class FiiPieChartCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        {
            if(index < 6){
                entries.append(PieChartDataEntry(value: fii.currentPercent/100, label: fii.symbol))
            } else {
                // Check if it is last fii
                otherPercent += fii.currentPercent
