...
import Foundation
import UIKit
class FiiSplitForm: UIViewController, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        let btInsert = UIBarButtonItem(title: "Inserir", style: UIBarButtonItemStyle.plain, target: self, action: #selector(FiiSplitForm.insertSplit))
    ...
    @IBAction func insertSplit(){
        ...
        if(isValidQuantity){
            ...
            fiiTransaction.type = Constants.TypeOp.SPLIT
            ...
            general.updateFiiData(symbol, type: Constants.TypeOp.SPLIT)
